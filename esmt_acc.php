...
if (mysqli_connect_errno()) {
    ...
    $query = "SELECT city_id, accommodation_type, duration, AVG(accommodation_cost / duration) AS avgDayCost FROM `trip` WHERE city_id = " . $cityId . " AND accommodation_type = '" . $accType . "'";
    ...
    if($result){
        ...
        $avgDayCost = $row['avgDayCost'];
        $estimatedCost = round($avgDayCost * $duration,0);
        echo "Estimated Accommodation Cost: ".$estimatedCost."$";
