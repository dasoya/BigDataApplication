<?php
    ...
    // 세션 변수 사용
        ...
        header("Location: /BigDataApplication/login.html");
        exit();        
    }
    ...
    //else{
    //    header("Location: /BigDataApplication/review/reviews.php");
    //    exit();  
    //}

    include "../dbconfig.php";
    include "getWriterId.php";
    include "show.php";
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-5 col-12">
                        ...
                        <h2 class="text-white">Write Review</h2>
                    </div>
        ...
        <section class="section-padding section-bg">
            <div class="container">
                <div class="">
                    ...
                    <div class="">
                        <h3 class="mb-4 pb-2">Edit your post</h3>
                    </div>
        
                    <div class="col-lg-12 col-12">
                        <form action="updatePost.php" method="post" class="custom-form contact-form" role="form">
                            <input type="hidden" name="reviewId" value="<?php echo $review['id']; ?>">

        
                            <div class="col-lg-12 col-12">
                                <div class="form-floating">
                                    <textarea class="form-control text-left" id="message" name="title" placeholder="Tell me about the project" style="resize: none; height: inherit;"><?php echo trim($review['title']);?></textarea>
                                    <label for="title">Title</label>
                                </div>
                                
                                <div class="form-floating">
                                    <textarea class="form-control text-left" id="message" name="body" placeholder="Tell me about the project" rows="6"><?php echo trim($review['body']);?></textarea>
                                    <label for="message">Tell me about your trip!</label>
                                </div>
                            </div>
