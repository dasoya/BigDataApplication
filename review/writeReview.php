        ...
        <section class="section-padding section-bg">
            <div class="container">
                <div class="">
                    ...
                    <div class="">
                        <h3 class="mb-4 pb-2">We'd love to hear from you

                        </h3>
                    </div>

                    <div class="col-lg-12 col-12">
                        <form action="reviewInsert.php" method="post" class="custom-form contact-form" role="form">
                            <!-- php로 보내서, redirect해야하나? -->
                            ...
                            <div class="col-lg-12 col-12">
                                ...
                                <div class="form-floating">
                                    ...
                                    <label for="floatingTextarea">Tell me about your trip !</label>
                                </div>
                            </div>
